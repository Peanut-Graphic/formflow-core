...
class UTMTracker {
     ...
     */
    private const SESSION_KEY = 'peanut_formcore_utm_data';

    /**
     * Cookie name for persisting UTM data
     */
    private const COOKIE_NAME = 'peanut_formcore_attribution';
    ...
    private function get_visitor_id(): string {
        ...
        if (isset($_COOKIE['peanut_formcore_visitor']) && $_COOKIE['peanut_formcore_visitor'] !== '') {
            return sanitize_text_field($_COOKIE['peanut_formcore_visitor']);
        }
