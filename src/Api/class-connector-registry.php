...
class ConnectorRegistry {
    ...
    public function init_connectors(): void {
         ...
         * });
         */
        do_action('peanut_formcore_register_connectors', $this);
         ...
         */
        $this->connectors = apply_filters('peanut_formcore_registered_connectors', $this->connectors);
    }
    ...
    public function register(ApiConnectorInterface $connector): bool {
        ...
        if (isset($this->connectors[$id])) {
            ...
            $allow_override = apply_filters(
                'peanut_formcore_allow_connector_override',
                false,
                $id,
                $connector,
                $this->connectors[$id]
         ...
         * @param ApiConnectorInterface $connector The connector instance
         */
        do_action('peanut_formcore_connector_registered', $id, $connector);
    ...
    public function unregister(string $id): bool {
         ...
         */
        do_action('peanut_formcore_connector_unregistered', $id, $connector);
    ...
    public function get_default(): ?ApiConnectorInterface {
        ...
        $default_id = apply_filters(
            'peanut_formcore_default_connector',
